      ...
      <div className={styles.chartsRow}>
        ...
        <div className={`${styles.chartPanel} ${styles.chartPanelDark}`}>
          ...
          <svg viewBox={`0 0 ${vw} ${vh}`} className={styles.chartSvg}>
            ...
            <line x1={padL} y1={padT} x2={padL} y2={padT + ch} stroke="rgba(0,0,0,0.1)" strokeWidth="1" />
            {/* Y-axis labels */}
            <text x={padL - 4} y={padT + 3} textAnchor="end" fill="#aaa" style={axisStyle}>120</text>
            <text x={padL - 4} y={padT + ch + 3} textAnchor="end" fill="#aaa" style={axisStyle}>0</text>
            {/* Line */}
            <path d={honPath} fill="none" stroke="#374151" strokeWidth="2" strokeLinejoin="round" strokeLinecap="round" />
            {/* Dots */}
            {xs.map((x, i) => (
